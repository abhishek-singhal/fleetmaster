    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-2 col-sm-5">
                ...
                <h2><a href="<?php echo $latest_event->event_page;?>" target="_blank" id="notnecessary">next event in</a></h2>
                <?php }else{?>
                        ...
                        <?php $count=0; foreach($members AS $member){ ?>
                            ...
                            <div class="col-sm-4">
                                <div class="single-event">
                                    ...
                                    <h4><a href="http://steamcommunity.com/profiles/<?php echo $member->steam_id;?>" target="_blank"><font color="white"><?php echo $member->steam_name;?></font></a></h4>
                                    <h5></h5>
                                </div>
                            </div>
                        <?php }?></div>
...
<section id="about">
    ...
    <div class="about-content">
        <h2>About us</h2>
        <p>FME was created when the well known VTC called ELS Shutdown. ELS was Run by Enlight and Josh, Who now own FME. </p>
...
<footer id="footer">
    <div class="container">
        <div class="text-center">
            <p>&copy;2017 <font color="#01ABAA">FleetMaster Events</font> All Rights Reserved.</p>
