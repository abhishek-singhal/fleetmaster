						...
						<div class="box-body">
							...
							<div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" name="notes" placeholder="DLC required? or any additional information you want to provide" required></textarea>
                                </div>
							</div>
                            <div class="col-md-12">
                                <div class="form-group">
...
$('#datetimepicker_format').datetimepicker({value:'<?php echo date('Y/m/d H:i',time());?>', format: $("#datetimepicker_format_value").val()});
